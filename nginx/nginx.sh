#!/bin/bash
# Link Hosting Kalian
namydev="raw.githubusercontent.com/mantap896/SaktiSSH/main/ssh"
# install webserver
apt -y install nginx php php-fpm php-cli php-mysql libxml-parser-perl
rm /etc/nginx/sites-enabled/default
rm /etc/nginx/sites-available/default
curl https://${namydev}/nginx.conf > /etc/nginx/nginx.conf
curl https://${namydev}/vps.conf > /etc/nginx/conf.d/vps.conf
...
wget -O /home/vps/public_html/index.html "https://${namydev}/index.html1"
